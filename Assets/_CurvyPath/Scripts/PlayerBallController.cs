    ...
    public class PlayerBallController : MonoBehaviour
    {
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            if ((other.gameObject.tag == "ChangeToColor1" || other.gameObject.tag == "ChangeToColor2" || other.gameObject.tag == "ChangeToColor3") && collision)
            {
                ...
                {
                    case "ChangeToColor1":
                        rendererObject.material.SetColor("_Color", GameManager.Instance.color1);
                        trailRender.startColor = new Color(GameManager.Instance.color1.r, GameManager.Instance.color1.g,
                        GameManager.Instance.color1.b, GameManager.Instance.color1.a);

                        trailRender.endColor = new Color(GameManager.Instance.color1.r, GameManager.Instance.color1.g,
                            GameManager.Instance.color1.b, 0);
                        body.gameObject.tag = "Color1";
                        gameObject.tag = "Color1";
                        break;
                    case "ChangeToColor2":
                        rendererObject.material.SetColor("_Color", GameManager.Instance.color2);
                        trailRender.startColor = new Color(GameManager.Instance.color2.r, GameManager.Instance.color2.g,
                        GameManager.Instance.color2.b, GameManager.Instance.color2.a);

                        trailRender.endColor = new Color(GameManager.Instance.color2.r, GameManager.Instance.color2.g,
                            GameManager.Instance.color2.b, 0);
                        body.gameObject.tag = "Color2";
                        gameObject.tag = "Color2";
                        break;
                    case "ChangeToColor3":
                        rendererObject.material.SetColor("_Color", GameManager.Instance.color3);
                        trailRender.startColor = new Color(GameManager.Instance.color3.r, GameManager.Instance.color3.g,
                        GameManager.Instance.color3.b, GameManager.Instance.color3.a);

                        trailRender.endColor = new Color(GameManager.Instance.color3.r, GameManager.Instance.color3.g,
                            GameManager.Instance.color3.b, 0);
                        body.gameObject.tag = "Color3";
                        gameObject.tag = "Color3";
                        break;
                }
        ...
        void createCollisionEffect( Vector3 position)
        {
            ...
            //main.startSizeX = gameObject.transform.localScale.x;
            //main.startSizeY = gameObject.transform.localScale.y;
            //main.startSizeZ = gameObject.transform.localScale.z;
        ...
        private void OnCollisionEnter(Collision collision)
        {
            if (collision.gameObject.tag == "Plane" && !die && first)
            {
                ...
                first = false;
                //Debug.Log("gravity " + Physics.gravity+" velocity "+velocity+" angle "+ ground.GetComponent<test>().up);
                //StartCoroutine(FixCamera());
            }
            //Camera.main.transform.eulerAngles = oriAngle+ ground.transform.eulerAngles;
        }
        ...
        IEnumerator FixPosition()
        {
            ...
            curve = new AnimationCurve(new Keyframe(0, pos.y), new Keyframe(0.5f, pos.y+ 15), new Keyframe(1, pos.y));
        ...
        private void OnCollisionExit(Collision collision)
        {
            if (collision.gameObject.tag== "ChangeToColor1" && change)
            {
                isCollision = false;
                //velocity = Vector3.zero;
                //gameObject.GetComponent<Rigidbody>().velocity = gameObject.transform.up * -10;
        ...
        void FixedUpdate()
        {
            ...
            Vector3 pos = gameObject.transform.position;
            pos.x = Mathf.Clamp(pos.x, -limitDistance, limitDistance - 5f);
        ...
        //{
        //    trailRender.gameObject.transform.position = Vector3.SmoothDamp(trailRender.gameObject.transform.position, new Vector3(transform.position.x, transform.position.y, transform.position.z -0.5f), ref newveolocity, 0.035f / (GameManager.Instance.speed / 200));
        //}
        ...
        private void Update()
        {
            ...
            trailRender.gameObject.transform.position = new Vector3(transform.position.x, transform.position.y, transform.position.z - 5.5f);
            if (move && hasMove)
            {
                hasMove = false;
                StartCoroutine(Wait());
